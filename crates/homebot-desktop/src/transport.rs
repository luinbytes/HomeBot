...
use homebot_protocol::{
    ApprovalDecisionRequest, AssistantPackInstallationSummary, AssistantPackSummary,
    AttachChatWorkspaceRequest, BotMutationRequest, BotResponse, BrowserActionRequest,
    BrowserActionResponse, BrowserCommand, BrowserMutationRequest, ChatTimelineResponse,
    ChatWorkspaceSummary, CheckpointDiffResponse, ClientMessage, CompactWorkingContextRequest,
    ...
    RoutineDefinition, RoutineRecordingSummary, RoutineRunSummary, RoutineSummary,
...
pub enum DesktopEvent {
    ...
    AssistantPacks(Vec<AssistantPackSummary>),
    AssistantPackInstalled(AssistantPackInstallationSummary),
